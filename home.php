        ...
        <div class="row" style="margin-top: 2rem;">
            <div class="col-4" style="margin-left: 1rem;">
                ...
                <div class="row" style="margin-top: 1rem;">
                    <div class="col">
                        <a href="adicionar.php" class="btn btn-outline-success d-grid gap-1 fs-2" style="height: 160px; width: 210px;">
                            <div class="row">
                    ...
                    <div class="col">
                        <a href="ocorrencias.php" class="btn btn-outline-info d-grid gap-1 fs-2" style="height: 160px; width: 210px;">
                            <div class="row">
                ...
                <div class="row" style="margin-top: 1rem;">
                    <div class="col">
                        <button type="button" class="btn btn-outline-dark d-grid gap-1 fs-2" data-bs-toggle="modal" data-bs-target="#PDF" style="height: 140px; width: 460px;">
                            <div class="row">
